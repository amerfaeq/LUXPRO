...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- تفعيل الدخول التلقائي (Automatic Entry) لتمكين الجسر ---
        if (NativeEngine.isLibraryLoaded()) {
            NativeEngine.setAutomaticEntry(true);
        }
    ...
    private void processToken(String token) {
        if (token != null && !token.trim().isEmpty()) {
            ...
            Intent updateIntent = new Intent("com.luxpro.max.UPDATE_ACCOUNT");
    ...
    public void startOAuthFlow(String provider) {
        ...
        switch (provider) {
            ...
            case "miniclip":
            case "bind":
                loginUrl = "https://www.miniclip.com/user/login/";
                break;
            default:
        ...
        Intent intent = new Intent(this, com.luxpro.max.auth.BridgeWebViewActivity.class);
        ...
        mDatabase.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snap) {
                ...
                if (Boolean.TRUE.equals(isActive)) {
                    ...
                    // --- Elite Security: IP Static Binding ---
                    fetchAndBindIP();
                    ...
                    Toast.makeText(LoginActivity.this, "Account is disabled.", Toast.LENGTH_LONG).show();
        ...
        FirebaseDatabase.getInstance().getReference("Admins").child(userId)
            .addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError e) {
                    showLoading(false);
                    if (btnLogin != null) btnLogin.setEnabled(true);
                    Toast.makeText(LoginActivity.this, "Admin DB Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
    }
    ...
    private void performBridgeHandshake(String provider) {
        OkHttpClient client = com.luxpro.max.auth.AuthBridgeClient.getInstance(this);
    ...
    private void fetchAndBindIP() {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                android.util.Log.e("LUX_SECURITY", "Failed to fetch IP for binding");
            }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    NativeEngine.getInstance().setSessionIP(ip);
                    android.util.Log.i("LUX_SECURITY", "Session IP Bound: " + ip);
                }
            }
        });
    }
