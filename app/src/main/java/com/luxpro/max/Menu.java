    ...
    public Menu(Context context) {
        ...
        try {
            ...
            if (decode != null && decode.length > 0) {
                android.graphics.Bitmap bitmap = BitmapFactory.decodeByteArray(decode, 0, decode.length);
                if (bitmap != null) {
                    startimage.setImageBitmap(bitmap);
                } else {
                    startimage.setImageResource(android.R.drawable.ic_menu_info_details);
                }
            } else {
                startimage.setImageResource(android.R.drawable.ic_menu_info_details);
            }
