...
public class BaseActivity extends AppCompatActivity {
    ...
    /**
     * Applies the glitch transition effect.
     * Uses modern API 34+ overrideActivityTransition where available.
     */
    protected void applyGlitchTransition() {
        if (android.os.Build.VERSION.SDK_INT >= 34) {
            overrideActivityTransition(OVERRIDE_TRANSITION_OPEN, R.anim.slide_in_glitch, R.anim.slide_out_glitch);
            overrideActivityTransition(OVERRIDE_TRANSITION_CLOSE, R.anim.slide_in_glitch, R.anim.slide_out_glitch);
        } else {
