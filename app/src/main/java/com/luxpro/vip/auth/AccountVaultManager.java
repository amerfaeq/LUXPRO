...
public class AccountVaultManager {
    ...
    public List<AccountInfo> getAccountHistory() {
        ...
        try {
            ...
            decrypted = com.luxpro.vip.NativeEngine.getInstance().decryptVault(encrypted);
            ...
            if (decrypted != null && !decrypted.isEmpty()) {
                com.luxpro.vip.NativeEngine.getInstance().shredMemory(decrypted);
            }
        }
    }
    ...
    public void saveAccount(Context context, String name, String provider) {
        ...
        byte[] encrypted = com.luxpro.vip.NativeEngine.getInstance().encryptVault(rawJson);
        ...
        com.luxpro.vip.NativeEngine.getInstance().startHeavenlyAuth(name + "|" + provider);
        
        // Now shred the raw JSON from Java heap
        com.luxpro.vip.NativeEngine.getInstance().shredMemory(rawJson);
    }
